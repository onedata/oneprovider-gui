...
const translations = {
  ...
  replica: 'replica',
  replicas: 'replicas',
  inheritedDisabledRemoveTip: '<strong>Inherited requirement</strong> – cannot be removed directly.<br>You can remove it from the directory indicated as the inheritance source.',
  statusHint: {
