/**
 * Edit or view XML of share handle metadata.
 *
 * @author Jakub Liput
...
/**
 * @typedef {Object} XmlOnlyMetadataSignature
 * @property {HTMLDivElement} Element
 * @property {XmlOnlyMetadataArgs} Args
 */

/**
 * @typedef {Object} XmlOnlyMetadataArgs
 * @property {Locale} locale
 * @property {() => string} onGenerateInitialXml
...
/**
 * @extends {Component<XmlOnlyMetadataSignature>}
 */
export default class ShareShowXmlOnlyMetadataComponent extends Component {
  @service media;
  @service i18n;
  ...
  generateInitialXml(initialData = {}) {
    return this.args.onGenerateInitialXml(initialData);
  }
