  ...
  config: {
    ...
    incremental: {
      ...
      tip: `
        ...
        <p class="text-left">If <strong>disabled</strong>, all files belonging to the dataset will be stored directly in the archive.</p>
      `,
    },
    baseArchiveGroup: {
      baseArchiveInfo: {
        ...
        tip: `
          ...
          <p class="text-left">To select a different base archive, locate the desired one in archive browser and use the "${createIncrementalArchive}" action from the context menu.</p>
        `,
      },
    },
    layout: {
      ...
      tip: `
        ...
        <p class="text-left"><strong>BagIt</strong> – Data in the archive are stored in The BagIt File Packaging Format.</p>
      `,
      options: {
        plain: {
          label: 'plain',
    ...
    includeDip: {
      ...
      tip: `
        ...
        <p class="text-left">For more information on DIP and AIP please search for <strong>Open Archival Information System</strong>.</p>
      `,
    },
    followSymlinks: {
      ...
      tip: `
        ...
        <p class="text-left"><strong>Note</strong>, that symbolic links pointing to files inside the dataset are always preserved, regardless of this setting. Their target paths are reconstructed to point to the corresponding files in the resulting archive.</p>`,
    },
  },
