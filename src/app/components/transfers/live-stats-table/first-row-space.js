...
export default Component.extend({
  ...
  virtualRowsNumber: computed(
    ...
    function getVirtualRowsNumber() {
      ...
      return firstRowListIndex == null && justOpened ? 1 : Math.max(0,
        firstRowListIndex);
    }),
  ...
  middleStickyClass: computed('middleStickyVisible', 'firstRowListIndex',
    function getTdClass() {
      return htmlSafe(
        this.get('middleStickyVisible') && this.get('firstRowListIndex') ? '' :
        'middle-sticky-hide'
      );
    }),
